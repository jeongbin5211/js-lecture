...
// 띄어쓰기 허용안됨
// 기호는 언더스코어, 달러만 사용 가능
// lowerCamelCase 형태를 지양합니다. : 소문자로 작성, 두 개 이상의 단어 결합 시 두 번째 단어의 첫 시작을 대문자로 지정

// now, _now, now25, now$ (o)
// 25now, now 25, *now (x)

// 영어 대소문자 구별 now != Now  !=(not)
// 예약어는 사용불가능
...
// let
// let 블록{} 범위 변수, 재할당이 가능

// 선언과 초기화
// 변수 변수명; (변수 선언)
// 변수명 = 값; (변수에 값을 할당)
// 변수 변수명 = 값; (선언과 동시에 할당 : 초기화한다 라고 함)
...
// var 키워드의 경우 변수를 중복해서 선언할 수 있다는 위험성, 변수가 속하는 범위가 애매하여 코드에 혼란을 줄 수 있다. (사용안함)
...
// UPPER)SNAKE_CASE 사용
// 모든 문자를 대문자로 작성, 두 개 이상의 단어가 결합될 때 _ 사용.
