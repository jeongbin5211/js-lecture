...
// <script>태그로 감싼 Javascript 코드는 브라우저가 로드될 때 자동으로 실행됨
...
// 4. 예약이(키워드) 사용 불가 : 자바스크립트에서 미리 정해 놓은 단어 (var, for, true, function 등)
...
// let 또는 const를 사용하여 변수를 선언합니다. (var 사용 금지)
