...
let person1 = new Person('jeongbin', 28, 'Developer');
let person2 = new Person('jiyoon', 28, 'Artist');

console.log(person1);
console.log(person2);

//? 2-3. Object.create()
// 명시적으로 프로토타입을 설정할 수 있는 새로운 객체를 생성하는 방법
...
let person4 = new Person2('Heo Jeong Bin', 28, 'Developer');
person4.greet();
...
let computer1 = {name: '3070'};
let computer2 = computer1;

computer2.name = '3070ti'
console.log(computer1.name); // 3070ti이 나옴 => 두 변수가 같은 메모리 주소를 참조하고 있기 때문이다.
...
let Human = { 
    ...
    // Human 객체의 메소드
    greet: function() {
        console.log(`Hello, my name is ${this.name}`); // 이 객체의 속성을 받아오고 싶을때 this.속성
    }
}
