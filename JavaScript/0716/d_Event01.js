...
//? 3. addEventListener 메서드: HTML 요소의 addEventListener 메서드를 사용하여 이벤트 핸들러 등록 => 표준 이벤트 모델 이라고 불림
// 표준 이벤트 모델을 사용하면 한 요소에 여러 개의 이벤트 핸들러 등록 가능
...
//! 이벤트 전파
// 이벤트는 일반적으로 특정 요소에서 발생한다.
// 해당 이벤트는 해당 요소의 부모 요소들로 '전파'됩니다.
