...
do {
  console.log(fruits3[index3]);
  index3++;
} while (index3 < fruits3.length);

//! 사용자 입력 받기

// 실행문 시작 전에 userInput의 변수를 선언해주세요.
// do 실행 코드 블럭에 사용자로부터 숫자를 입력 받아 userInput변수에 할당
// 사용자가 10보다 큰 숫자를 입력할 때 까지 계속해서 사용자에게 입력을 요청합니다.

let userInput;

do {
  userInput = Number(prompt("10보다 큰 숫자를 입력해주세요."));
} while (userInput <= 10);
...
let fruit4 = ['apple', 'banana', 'cherry'];
for (let index4 in fruit4) {
  console.log(index4 + ":" + fruit4[index4]);
};
